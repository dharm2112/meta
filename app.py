"""FastAPI backend with premium UI for the Code Review Assistant."""
...
"""
        ...
        # Some models might still return markdown backticks
...
if __name__ == "__main__":
    print("Starting Premium UI Server on http://0.0.0.0:7860")
